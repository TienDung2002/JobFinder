...
class SalaryTrackingAdapter(private val context: Context, private var jobList: List<AppliedJobModel>) :
    RecyclerView.Adapter<SalaryTrackingAdapter.PostedJobViewHolder>() {
