...
class BUserStatisticalActivity : AppCompatActivity() {
    ...
    private fun updateBarChartMonYea(month: Int, year: Int) {
        val expenseList = viewModel.expenseList.value
        expenseList?.let {
            val weeklyTotals = IncomeHandle.calculateWeeklyIncome(expenseList, year, month)
            drawBarChart( mapOf(), weeklyTotals)
        }
    }
    ...
    private fun drawPieChart(totalIncomeByJobType: Map<Int,Double>) {
        ...
        val colors = listOf(
            ...
            ContextCompat.getColor(this@BUserStatisticalActivity, R.color.green),
            ContextCompat.getColor(this@BUserStatisticalActivity, R.color.ratingStar),
            ContextCompat.getColor(this@BUserStatisticalActivity, R.color.cyan),
            ContextCompat.getColor(this@BUserStatisticalActivity, R.color.red),
            ContextCompat.getColor(this@BUserStatisticalActivity, R.color.purple),
            ContextCompat.getColor(this@BUserStatisticalActivity, R.color.pink),
            ContextCompat.getColor(this@BUserStatisticalActivity, R.color.teal)
        )
    ...
    private fun drawChartBuser() {
        ...
        viewModel.fetchExpenseByJobTypeId(uid.toString())

        viewModel.expenseByJobTypeList.observe(this){ newIncomeListByJobType->
            val totalIncomeByJobType = IncomeHandle.calculateIncomeByJobType(newIncomeListByJobType)
            drawPieChart(totalIncomeByJobType)
        }

        workHourViewModel.fetchAmountJobPost(uid.toString())
